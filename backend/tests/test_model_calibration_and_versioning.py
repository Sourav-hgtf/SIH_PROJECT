...
def test_model_artifact_metadata_and_version_separation(setup_training_db: Session):
    """Requirement 1, 2, 3, 4: Model training produces artifact with separated versions."""
    ...
    assert "platt" in model_data["calibration_version"] or "uncalibrated" in model_data["calibration_version"]


def test_prediction_reproducibility_and_version_exposure():
    """Requirement 5 & 6: Prediction responses expose actual model version, threshold, and preprocessing."""
